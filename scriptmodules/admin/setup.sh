...
function post_update_setup() {
    ...
    printMsgs "dialog" "***IMPORTANT NOTE***\n\nThis repo is no longer maintained. Please update the newest image from http://theretroarena.com"
...
function gui_setup() {
    ...
    while true; do
        ...
        cmd=(dialog --backtitle "$__backtitle" --title "RetroPie-Setup Script" --cancel-label "Exit" --item-help --help-button --default-item "$default" --menu "Version: v$__version\nLast Commit: $commit" 22 76 16)
        options=(
