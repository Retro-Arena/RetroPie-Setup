...
function gui_setup() {
    ...
    while true; do
        ...
        cmd=(dialog --backtitle "$__backtitle" --title "RetroPie-Setup Script" --cancel-label "Exit" --item-help --help-button --default-item "$default" --menu "Retro-Arena: v1.63 FINAL\nSetup-Scrpt: v$__version\nLast Commit: $commit" 22 76 16)
        options=(
