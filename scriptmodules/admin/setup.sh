...
function gui_setup() {
    ...
    while true; do
        ...
        cmd=(dialog --backtitle "$__backtitle" --title "TheRA-Setup Script" --cancel-label "Exit" --item-help --help-button --default-item "$default" --menu "TheRA: v1.62 | Setup-Script: v$__version\nLast Commit: $commit" 22 76 16)
        options=(
